...
import 'package:project/GiftDetailsPage.dart';
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            tileColor: gift['status'] == 'Pledged' ? Colors.green[100] : Colors.white,
            trailing: Row(
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => GiftDetailsPage(gift: gift, onSave: (updatedGift) => editGift(index, updatedGift)),
                      ),
                    );
                  },
                ),
